                                ...
                                <div v-for="(f, index) in filterFoods" :key="index">
                                    <div class="box-content row">
                                        <div class="image-box col-sm-3" style="padding-left: 0;">
                                            <img :src="require(`../assets/images/dis-2.png`)" alt=""
...
export default {
    ...
    methods: {
        ...
        async cancelBtn() {
            await axios.delete("/cartItem/" + this.user._id);
        ...
        async removeBtn(index) {
            await axios.delete("/cartItem/" + this.user._id + "/" + this.cartItem[index]);
        ...
        async getAllCartItem() {
            if (this.user) {
                let existItem = await axios.get('/cartItem/' + this.user._id);
